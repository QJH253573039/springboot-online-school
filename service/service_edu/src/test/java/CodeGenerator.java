...
public class CodeGenerator {
    ...
    public void genCode() {
        ...
        dsc.setUrl("jdbc:mysql://119.45.13.228:3306/" + prefix + "_guli_" + moduleName + "?serverTimezone=GMT%2B8");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("qjh900812");
...
//
        ...
        // strategy.entityTableFieldAnnotationEnable(true); //添加 @TableFiled
